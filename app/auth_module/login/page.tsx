...
import {login, saveAuthToken, saveUserData} from "@/app/api/authentication/auth";
...
export default function LoginPage() {
    ...
    const handleAutoLogin = async (email: string, pwd: string) => {
        ...
        try {
            ...
            setFormErrors({
                general: error instanceof Error ? error.message : 'Auto-login failed. Please login manually.'
            });
    ...
    return (
        <div className={styles.pageBackground}>
            <div className={styles.column}>
                ...
                {signupSuccess && (
                    <div className={`${styles.message} ${styles.messageSuccess}`} style={{ marginBottom: '20px', marginTop: '20px' }}>
